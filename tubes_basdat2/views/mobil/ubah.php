							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('mobil/proses_ubah/' . $mobil->id_mobil) ?>" enctype="multipart/form-data">
								  	...
								  	<div class="form-group">
								  		...
								  		<input type="text" value="<?= $mobil->nama ?>" name="nama" id="nama" required="required" placeholder=" " autocomplete="off" class="form-control">
								  	</div>
								  	<div class="row">
									  	<div class="form-group col-6">
									  		<label for="warna">Warna Mobil</label>
									  		<input type="text" value="<?= $mobil->warna ?>" name="warna" id="warna" required="required" placeholder=" " autocomplete="off" class="form-control">
									  	</div>
									  	<div class="form-group col-6">
									  		<label for="jumlah_kursi">Jumlah Kursi</label>
									  		<input type="number" value="<?= $mobil->jumlah_kursi ?>" name="jumlah_kursi" id="jumlah_kursi" required="required" placeholder=" " autocomplete="off" class="form-control">
									  	</div>
								  	</div>
									<div class="row">
									  	<div class="form-group col-6">
									  		<label for="no_polisi">No Polisi</label>
									  		<input type="text" value="<?= $mobil->no_polisi ?>" name="no_polisi" id="no_polisi" required="required" placeholder=" " autocomplete="off" class="form-control">
									  	</div>
									  	<div class="form-group col-6">
									  		<label for="tahun_beli">Tahun Beli</label>
									  		<input type="number" value="<?= $mobil->tahun_beli ?>" name="tahun_beli" id="tahun_beli" required="required" placeholder=" " autocomplete="off" class="form-control">
									  	</div>
								  	</div>
								  	<div class="form-group">
								  		<label for="gambar">Gambar Mobil</label>
								  		<input type="file" name="gambar" id="gambar" required="required" placeholder=" " autocomplete="off" class="form-control-file">
								  	</div>
								  	<div class="form-group">
