							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('perjalanan/tambah') ?>">
								  	<div class="form-group">
										...
										<input type="text" class="form-control" name="asal" id="asal" autocomplete="off" required="required" placeholder=" ">
								  	</div>
								  	<div class="form-group">
										<label for="tujuan">Kota Tujuan</label>
										<input type="text" class="form-control" name="tujuan" id="tujuan" autocomplete="off" required="required" placeholder=" ">
								  	</div>
								  	<div class="form-group">
										<label for="jarak">Jarak (dalam KM)</label>
										<input type="number" class="form-control" name="jarak" id="jarak" autocomplete="off" required="required" placeholder=" ">
								  	</div>
								  	<div class="form-group">
