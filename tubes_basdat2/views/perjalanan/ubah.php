							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('perjalanan/proses_ubah/' . $perjalanan->id) ?>">
								  	<div class="form-group">
										...
										<input type="text" value="<?= $perjalanan->asal ?>" class="form-control" name="asal" id="asal" autocomplete="off" required="required" placeholder=" ">
								  	</div>
								  	<div class="form-group">
										<label for="tujuan">Kota Tujuan</label>
										<input type="text" value="<?= $perjalanan->tujuan ?>" class="form-control" name="tujuan" id="tujuan" autocomplete="off" required="required" placeholder=" ">
								  	</div>
								  	<div class="form-group">
										<label for="jarak">Jarak (dalam KM)</label>
										<input type="number" value="<?= $perjalanan->jarak ?>" class="form-control" name="jarak" id="jarak" autocomplete="off" required="required" placeholder=" ">
								  	</div>
								  	<div class="form-group">
